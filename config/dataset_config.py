...
class DatasetConfig:
    ...
    samm_excel_path = "data/SAMM/SAMM_annotation.xlsx"
    ...
    fourd_excel_path = "data/4DMicro/4DME_Labelling_Micro_release_v1.xlsx"
    fourd_cropped_dataset_path = "data/4DMicro/gray_micro_crop"
    fourd_dataset_path = "data/4DMicro/gray_micro"
    fourd_optical_flow = "data/4DMicro/4DME_uv_frames_secrets_of_OF.npy"
    ...
    casme3a_excel_path = "data/CASME3/CASME3_part_A_v2.xls"
    casme3a_dataset_path = "data/CASME3/ME_A"
    casme3a_cropped_dataset_path = "data/CASME3/ME_A_cropped"
    casme3a_optical_flow = "data/CASME3/casme3a_uv_frames_secrets_of_OF.npy"
